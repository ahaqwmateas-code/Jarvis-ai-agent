...
import * as PasteHelperMac from './paste-helper';
import * as PasteHelperCrossPlatform from './paste-helper.cross-platform';
// macOS keeps the existing AppleScript-based paste helper unchanged;
// Windows/Linux use the clipboard+keystroke implementation instead.
const PasteHelper = process.platform === 'darwin' ? PasteHelperMac : PasteHelperCrossPlatform;
