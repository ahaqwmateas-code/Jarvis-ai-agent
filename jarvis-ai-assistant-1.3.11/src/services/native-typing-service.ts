...
export class NativeTypingService {
  ...
  private loadNativeModule(): boolean {
    ...
    if (process.platform !== 'darwin') {
      // No cross-platform equivalent yet for background typing detection
      // (this only powers the optional "nudge" feature, not core
      // dictation). Degrading gracefully rather than throwing.
      console.log('[NativeTypingService] Not available on this platform — typing nudge feature disabled');
      return false;
    }
